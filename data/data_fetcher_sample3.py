    ...
    try:
        ...
        def on_market_data_update(md):
            ...
            current_data = (
                ...
                md.volume if md.volume else 0
            )
            if current_data != last_data and all(value is not None for value in current_data[:-1]):
                ...
                volume_color = Fore.YELLOW if current_data[3] > 0 else Fore.WHITE
                ...
                data = [
                    ...
                    f"Volume: {volume_color}{current_data[3]}{Style.RESET_ALL}",
