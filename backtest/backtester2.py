...
# Define trading conditions: EMA Crossover Strategy
data['Long'] = (data['EMA50'].shift(1) <= data['EMA200'].shift(1)) & (data['EMA50'] > data['EMA200'])
data['Short'] = (data['EMA50'].shift(1) >= data['EMA200'].shift(1)) & (data['EMA50'] < data['EMA200'])
